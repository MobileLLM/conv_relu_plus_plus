...
cmake -DCMAKE_TOOLCHAIN_FILE=/Users/kr/Downloads/android-ndk-r21e/build/cmake/android.toolchain.cmake -DNCNN_OPENMP=ON -DNCNN_BENCHMARK=ON -DNCNN_BUILD_TESTS=ON -DANDROID_ABI="armeabi-v7a" -DANDROID_ARM_NEON=ON -DANDROID_PLATFORM=android-19 ..
cmake -DCMAKE_TOOLCHAIN_FILE=/Users/kr/Downloads/android-ndk-r21e/build/cmake/android.toolchain.cmake -DNCNN_OPENMP=ON -DNCNN_BENCHMARK=ON -DNCNN_BUILD_TESTS=ON -DANDROID_ABI="arm64-v8a" -DANDROID_ARM_NEON=ON -DANDROID_PLATFORM=android-19 ..
